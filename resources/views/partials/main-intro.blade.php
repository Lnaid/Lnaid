<div class="welcome-content text-left">
    <div class="intro_slides owl-carousel">
        <div class="">
        ...
        <div class="">
            <div class="promo-section">
                <h3 class="special-head cyan">How to get started</h3>
            </div>
            <h4 class="bold wow fadeInUp b-text" data-wow-delay="0.2s">#Lnaid - Alumni</h4>
            <p class="wow fadeInUp" data-wow-delay="0.3s">Register as an Alumni or Sponsor - browse through request made by students and kindly make your donations</p>
        </div>
    ...
    <div class="info-btn-group fadeInUp" data-wow-delay="0.4s">
        ...
        <div class="multi-button float-right">
          <a class="btn" href="{{ route('signup.student')}}">Student</a>
          <a class="btn" href="{{ route('signup.sponsor')}}"><span>Sponsor</span></a>
          <a class="btn" href="#">Alumni</a>
        </div>
    </div>
