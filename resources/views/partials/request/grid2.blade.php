<!-- ##### Request Grid2  Start ##### -->
<section class="feature-request-area pt-125 pb-100">
    <div class="">
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                <div class="section-title text-center mb-85 wow fadeInUp2  animated" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp2;">
                    <h6 class="left-line pl-75 pr-75">Features requests</h6>
                    <h2>We've Take A Mission To <br>
                        <span>Solve The request</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card requests grey-bg d-sm-flex mb-30 wow fadeInUp2  animated" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp2;">
                    ...
                    <div class="projects__content">
                        ...
                        <div class="skill mb-30">
                            <p class="text-secondary" >Raised <span>$2535</span></p>
                            <div class="progress">
                ...
                <div class="card requests grey-bg d-sm-flex mb-30 wow fadeInUp2  animated" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp2;">
                    ...
                    <div class="projects__content">
                        ...
                        <div class="skill mb-30">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" aria-valuenow="29" aria-valuemin="0" aria-valuemax="29">
                                    <h5>29%</h5>
                                </div>
                            </div>
                        </div>
                        <div class="projects__content--manager">
                            <ul class="request-manager">
                                <li><a href="#"><img src="assets/img/request/01.png" alt="">
                                        <span>Somalia</span></a></li>
                                <li>
                                    <p class="time"><i class="far fa-clock"></i> 7 Days Left</p>
                                </li>
                ...
                <div class="card requests grey-bg d-sm-flex mb-30 wow fadeInUp2  animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp2;">
                    ...
                    <div class="projects__content">
                        ...
                        <div class="skill mb-30">
                            <p>Raised <span>$2535</span></p>
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" aria-valuenow="72" aria-valuemin="0" aria-valuemax="72">
                                    <h5>72%</h5>
                                </div>
                            </div>
                        </div>
