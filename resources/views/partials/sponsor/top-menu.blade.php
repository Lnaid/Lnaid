<!-- hender top menu start -->
<div class="main-header">
    <div class="logo"><img src="{{ asset('assets/dashboard/images/logo.png') }}" alt=""></div>
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            <div class="user col align-self-end"><img src="{{ Auth::user()->profile_photo_url }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" />
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <div class="dropdown-header"><i class="i-Lock-User mr-1"></i> {{ auth()->user()->name }}</div><a class="dropdown-item">Account settings</a><a class="dropdown-item">Billing history</a>
