<x-main-layout>
   @section('content')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-6 col-md-12">
                            <div class="welcome-content text-left">
                                ...
                                <p class="wow fadeInUp" data-wow-delay="0.3s">Makes it easy for students in higher institutions to request and access financial aid at various levels.</p>
        ...
        <section class="section-padding-0-70 relative map-before">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 offset-lg-0 col-md-10 offset-md-1">
                        <div class="who-we-contant mt-s">
                            ...
                            <h4 class="d-text bold fadeInUp" data-wow-delay="0.3s">Loan And Funding Company with Experienced Staff provide you with optimal Financial Solutions</h4>
                            <p class="fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at dictum risus, non suscipit arcu. Quisque aliquam posuere tortor, sit amet convallis nunc scelerisque in.</p>
                            ...
                            <a class="btn info-btn green-btn mt-30 fadeInUp" data-wow-delay="0.6s" href="services.html">Read More</a>
                        </div>
                    </div>
        ...
        <section class="faq-timeline-area section-padding-0-85" id="faq">
            <div class="container">
                <div class="section-heading text-center">
